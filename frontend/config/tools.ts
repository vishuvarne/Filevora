...
export type CategorySlug = "pdf" | "image" | "gif" | "audio-video" | "archive" | "utilities";
...
export const CATEGORY_META: Record<CategorySlug, { name: string; description: string; seoTitle: string; seoDescription: string }> = {
    pdf: {
        name: "PDF Tools",
        description: "Convert, merge, split, compress, and rotate PDFs — all in your browser.",
        seoTitle: "Free PDF Tools Online – Convert, Merge, Compress PDF | ConvertLocally",
        seoDescription: "All-in-one PDF toolkit. Merge, split, compress, rotate, and convert PDFs 100% locally in your browser. No uploads, no signup, totally free.",
    },
    image: {
        name: "Image Tools",
        description: "Convert, compress, resize, crop, and edit images in 100+ formats.",
        seoTitle: "Free Image Converter & Editor Online – JPG, PNG, WebP, HEIC | ConvertLocally",
        seoDescription: "Convert images between JPG, PNG, WebP, HEIC, AVIF and 100+ formats. Compress, resize, crop, and edit photos locally in your browser.",
    },
    gif: {
        name: "GIF Tools",
        description: "Create GIFs from videos and images, or convert GIFs to video.",
        seoTitle: "Free GIF Maker & Converter Online | ConvertLocally",
        seoDescription: "Create GIFs from MP4, WebM, MOV videos or images. Convert GIFs to MP4 or APNG. All processing done locally in your browser.",
    },
    "audio-video": {
        name: "Audio & Video",
        description: "Extract audio, convert formats, compress, and boost volume.",
        seoTitle: "Free Audio & Video Converter Online – MP3, MP4 | ConvertLocally",
        seoDescription: "Convert video to MP3, compress audio, boost volume, and record voice. Fast, free, and private browser-based processing.",
    },
    archive: {
        name: "Archive Tools",
        description: "Convert and extract RAR, 7z, and tar.gz archives.",
        seoTitle: "Free Archive Converter Online – RAR, ZIP, 7Z | ConvertLocally",
        seoDescription: "Convert RAR to ZIP, extract 7z files, and handle tar.gz archives online for free. No software installation needed.",
    },
    utilities: {
        name: "Utilities",
        description: "Unit converters, time zone tools, QR codes, and more.",
        seoTitle: "Free Online Utilities – Unit Converter, QR Code, Time Zones | ConvertLocally",
        seoDescription: "Convert units (length, weight, temperature), generate QR codes, and convert time zones. All free online tools.",
    },
};

export function getToolsByCategory(slug: CategorySlug): ToolDef[] {
    return TOOLS.filter(t => t.categorySlug === slug);
}

export function getCategoryForTool(toolId: string): CategorySlug | null {
