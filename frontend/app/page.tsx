...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://convertlocally.com/",
  },
  openGraph: {
    title: "ConvertLocally - Free Online File Converter | PDF, Image, Video",
    ...
    images: [{
      ...
      width: 1200,
      height: 630,
      alt: "ConvertLocally - Free Online File Converter",
    }],
  },
  twitter: {
    card: "summary_large_image",
    title: "ConvertLocally - Free Online File Converter",
    description: "60+ free tools to convert, merge, compress files. No signup required.",
