...
export default function Footer() {
    ...
    return (
        <footer
            className={isNeu
                ? "pt-16 pb-12 mt-auto font-spaceGrotesk"
                : "bg-secondary/30 border-t border-border pt-16 pb-12 mt-auto font-sans"
            }
            style={isNeu ? {
                background: "var(--nb-bg)",
                borderTop: "3px solid var(--nb-border)",
                contentVisibility: 'auto',
            } as any : { contentVisibility: 'auto' } as any}
        >
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
                            <input
                                ...
                                className={isNeu
                                    ? "flex-1 nb-input"
                                    : "flex-1 bg-background border border-input text-foreground px-5 py-3.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary placeholder:text-muted-foreground transition-all"
                                }
                                value={email}
                            ...
                            <button
                                ...
                                disabled={status === "loading" || status === "success"}
                                className={isNeu
                                    ? `nb-btn whitespace-nowrap ${status === "success" ? "!bg-[var(--nb-green)]" : ""}`
                                    : `px-8 py-3.5 rounded-xl font-bold transition-all shadow-lg active:scale-95 whitespace-nowrap ${status === "success"
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-x-4 gap-y-10 sm:gap-8 mb-16 text-sm">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-muted-foreground">
                            <li><Link href="#" prefetch={false} className="hover:text-primary transition-colors">MP4 Converter</Link></li>
                            <li><Link href="/tools/video-to-gif/" prefetch={false} className="hover:text-primary transition-colors">Video to GIF</Link></li>
                            <li><Link href="#" prefetch={false} className="hover:text-primary transition-colors">MOV to MP4</Link></li>
                            <li><Link href="#" prefetch={false} className="hover:text-primary transition-colors">MP3 Converter</Link></li>
                            <li><Link href="#" prefetch={false} className="hover:text-primary transition-colors">MP4 to MP3</Link></li>
                            <li><Link href="#" prefetch={false} className="hover:text-primary transition-colors">Video to MP3</Link></li>
                            <li><Link href="#" prefetch={false} className="hover:text-primary transition-colors">AVI Converter</Link></li>
                            <li><Link href="#" prefetch={false} className="hover:text-primary transition-colors">WAV Converter</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-muted-foreground">
                            <li><Link href="/tools/convert-image/" prefetch={false} className="hover:text-primary transition-colors">Image Converter</Link></li>
                            <li><Link href="/tools/image-compressor/" prefetch={false} className="hover:text-primary transition-colors">Compress Image</Link></li>
                            <li><Link href="#" prefetch={false} className="hover:text-primary transition-colors">Resize Image</Link></li>
                            <li><Link href="#" prefetch={false} className="hover:text-primary transition-colors">Crop Image</Link></li>
                            <li><Link href="#" prefetch={false} className="hover:text-primary transition-colors">Rotate Image</Link></li>
                            <li><Link href="#" prefetch={false} className="hover:text-primary transition-colors">PNG to JPG</Link></li>
                            <li><Link href="#" prefetch={false} className="hover:text-primary transition-colors">JPG to PNG</Link></li>
                            <li><Link href="#" prefetch={false} className="hover:text-primary transition-colors">HEIC to JPG</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-muted-foreground">
                            ...
                            <li><Link href="/tools/pdf-to-excel/" prefetch={false} className="hover:text-primary transition-colors">PDF to Excel</Link></li>
                            <li><Link href="/tools/word-to-pdf/" prefetch={false} className="hover:text-primary transition-colors">Word to PDF</Link></li>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-muted-foreground">
                            <li><Link href="/tools/unit-converter/" prefetch={false} className="hover:text-primary transition-colors">Unit Converter</Link></li>
                            <li><Link href="/tools/length-converter/" prefetch={false} className="hover:text-primary transition-colors">Length Converter</Link></li>
                            <li><Link href="/tools/weight-converter/" prefetch={false} className="hover:text-primary transition-colors">Weight Converter</Link></li>
                            <li><Link href="/tools/temperature-converter/" prefetch={false} className="hover:text-primary transition-colors">Temperature</Link></li>
                            <li><Link href="/tools/time-converter/" prefetch={false} className="hover:text-primary transition-colors">Time Converter</Link></li>
                            <li><Link href="/tools/speed-converter/" prefetch={false} className="hover:text-primary transition-colors">Speed Converter</Link></li>
                            <li><Link href="/tools/volume-converter/" prefetch={false} className="hover:text-primary transition-colors">Volume</Link></li>
                            <li><Link href="/tools/area-converter/" prefetch={false} className="hover:text-primary transition-colors">Area Converter</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3 text-muted-foreground">
                            ...
                            <li><Link href="/terms" prefetch={false} className="hover:text-primary transition-colors">Terms of Service</Link></li>
                            <li><Link href="/security" prefetch={false} className="hover:text-primary transition-colors">Security</Link></li>
                        </ul>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 border-t border-border/50 pt-12">
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2 sm:gap-3 text-sm">
                            <Link href="/tools/collage-maker/" prefetch={false} className="px-3 py-1.5 bg-background border border-border rounded-full text-muted-foreground hover:text-primary hover:border-primary/50 transition-all text-[11px] sm:text-xs">Collage Maker</Link>
                            <Link href="/tools/image-resizer/" prefetch={false} className="px-3 py-1.5 bg-background border border-border rounded-full text-muted-foreground hover:text-primary hover:border-primary/50 transition-all text-[11px] sm:text-xs">Image Resizer</Link>
                            <Link href="/tools/crop-image/" prefetch={false} className="px-3 py-1.5 bg-background border border-border rounded-full text-muted-foreground hover:text-primary hover:border-primary/50 transition-all text-[11px] sm:text-xs">Crop Image</Link>
                            <Link href="/tools/color-picker/" prefetch={false} className="px-3 py-1.5 bg-background border border-border rounded-full text-muted-foreground hover:text-primary hover:border-primary/50 transition-all text-[11px] sm:text-xs">Color Picker</Link>
                            <Link href="/tools/meme-generator/" prefetch={false} className="px-3 py-1.5 bg-background border border-border rounded-full text-muted-foreground hover:text-primary hover:border-primary/50 transition-all text-[11px] sm:text-xs">Meme Generator</Link>
                            <Link href="/tools/photo-editor/" prefetch={false} className="px-3 py-1.5 bg-background border border-border rounded-full text-muted-foreground hover:text-primary hover:border-primary/50 transition-all text-[11px] sm:text-xs">Photo Editor</Link>
                            <Link href="/tools/qr-code-generator/" prefetch={false} className="px-3 py-1.5 bg-background border border-border rounded-full text-muted-foreground hover:text-primary hover:border-primary/50 transition-all text-[11px] sm:text-xs">QR Code Generator</Link>
                        </div>
                    </div>
                    <div>
                        <h3 className="text-foreground font-bold mb-4 flex items-center gap-2">
