        ...
        <div className="h-full flex flex-col">
            {!file ? (
                <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
                    ...
                    <h3 className="text-2xl font-bold text-foreground mb-2">Chat with PDF</h3>
                    <p className="text-muted-foreground mb-8">Upload a document to start analyzing.</p>
                ...
                <>
                    <div className="p-4 bg-card border-b border-border flex items-center justify-between shrink-0">
                        ...
                        <button onClick={() => setFile(null)} className="text-xs text-red-500 hover:text-red-600 font-bold px-3 py-1 rounded-full bg-background border border-border hover:bg-secondary">
                            Change File
                        </button>
                    </div>
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4 custom-scrollbar bg-background">
                        {isProcessing && (
                            <div className="flex justify-center p-4">
                                <span className="loading loading-dots loading-md text-primary">Analyzing...</span>
                            </div>
                        )}
                    ...
                    <div className="p-4 border-t border-border shrink-0 bg-card">
                        <div className="flex gap-2">
                            <input
                                className="flex-1 bg-background border border-border rounded-xl px-4 py-2 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all text-foreground placeholder:text-muted-foreground"
                            ...
                            <button
                                ...
                                className="bg-primary hover:bg-primary/90 disabled:opacity-50 text-primary-foreground p-2 rounded-xl transition-colors"
                            >
