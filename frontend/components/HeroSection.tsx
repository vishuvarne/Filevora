...
export default function HeroSection() {
    ...
    return (
        <div className="relative isolate pt-14 dark:bg-slate-900">
            ...
            <div className="py-16 sm:py-20 lg:pb-8">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-4xl text-center">
                        ...
                        <p className="mt-6 sm:mt-8 text-lg sm:text-xl leading-7 sm:leading-8 text-muted-foreground max-w-3xl mx-auto px-4 sm:px-0">
                            <span className="inline-flex items-center font-bold text-green-500 mr-2 tracking-wide">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-6 h-6 mr-1.5">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                100% Private & Secure.
                            </span>
                            Your files never leave your device. All processing happens entirely within your browser locally using WebAssembly. We do not use servers, we do not upload your documents, and we don't store your data. Everything is completely offline-capable.
                        </p>
