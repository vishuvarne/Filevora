...
function ToolInterfaceInner({ tool }: ToolInterfaceProps) {
    ...
    const [expandedFileView, setExpandedFileView] = useState(false);
    ...
    // Compression Modes: 'easy', 'manual', 'target'
    const [pdfCompressionMode, setPdfCompressionMode] = useState<'easy' | 'manual' | 'target'>('easy');
    const [pdfTargetSizeKB, setPdfTargetSizeKB] = useState(100);
    ...
    const handleProcess = async (overrides?: { targetFormat?: string, compressionLevel?: string }) => {
        ...
        try {
            ...
            if (tool.id === "compress-pdf") {
                if (pdfCompressionMode === 'target') {
                    formData.append("target_size_kb", pdfTargetSizeKB.toString());
                } else if (pdfCompressionMode === 'manual' && !overrides?.compressionLevel) { // If manual and no override
            ...
            <div className="mt-2 w-full">
                ...
                {tool.endpoint === "/coming-soon" ? (
                    ...
                    <>
                                        ...
                                        {files.length > 0 && (
                                            <div className="grid grid-cols-1 lg:grid-cols-[3fr_1fr] gap-0 animate-in fade-in zoom-in-95 duration-300 bg-card dark:bg-[#1A1D24] rounded-[2rem] shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                                                ...
                                                <div className="space-y-3 min-w-0 p-4 sm:p-5 lg:p-6 flex flex-col min-h-[50vh]">
                                                    ...
                                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-1 sm:px-2 w-full">
                                                        <span className="text-sm font-bold text-muted-foreground uppercase tracking-wider shrink-0">Selected Files</span>
                                                        <div className="flex items-center justify-end gap-1.5 sm:gap-2 w-full sm:w-auto">
                                                            <button
                                                                onClick={() => setExpandedFileView(true)}
                                                                className="flex-1 sm:flex-none flex items-center justify-center gap-1 sm:gap-1.5 px-2 sm:px-4 py-2 bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400 border-[2px] border-slate-900 dark:border-slate-800 shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] sm:shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] sm:hover:shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] active:translate-y-0 active:shadow-none rounded-full text-[10px] sm:text-xs font-black uppercase tracking-wider transition-all sm:min-w-28 whitespace-nowrap"
                                                                title="Expand to easily rearrange files"
                                                            >
                                                                <span>Expand</span>
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0">
                                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15" />
                                                                </svg>
                                                            </button>
                                                            <button
                                                                onClick={() => setFiles([])}
                                                                className="flex-1 sm:flex-none flex items-center justify-center gap-1 sm:gap-1.5 px-2 sm:px-4 py-2 bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 border-[2px] border-slate-900 dark:border-slate-800 shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] sm:shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] sm:hover:shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] active:translate-y-0 active:shadow-none rounded-full text-[10px] sm:text-xs font-black uppercase tracking-wider transition-all sm:min-w-28 whitespace-nowrap"
                                                            ...
                                                            <button
                                                                ...
                                                                className="flex-1 sm:flex-none flex items-center justify-center gap-1 sm:gap-1.5 px-2 sm:px-4 py-2 bg-primary text-white border-[2px] border-slate-900 dark:border-slate-800 shadow-[2px_2px_0px_0px_rgba(15,23,42,1)] sm:shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] sm:hover:shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] active:translate-y-0 active:shadow-none rounded-full text-[10px] sm:text-xs font-black uppercase tracking-wider transition-all sm:min-w-28 whitespace-nowrap"
                                                                title={tool.multiple ? "Add more files to the list" : "Replace current file"}
                                                            >
                                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0">
                        ...
                        {/* Expanded File View Modal for easy rearranging */}
                        <AnimatePresence>
                            {expandedFileView && (
                                <m.div 
                                ...
                                >
                                    <div className="flex items-center justify-between p-4 border-b border-border bg-card/80 shadow-sm">
                                        <div className="flex items-center gap-3">
                                            <div className="w-10 h-10 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-xl flex items-center justify-center border-2 border-slate-900 dark:border-slate-800 shadow-[2px_2px_0px_0px_rgba(15,23,42,1)]">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15" />
                                                </svg>
                                            </div>
