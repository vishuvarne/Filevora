...
export default function AIAssistant({ tool, files, currentFormat, compressionLevel, quality = 85, onApply }: AIAssistantProps) {
    ...
    return (
        <div className="mb-4 animate-in fade-in slide-in-from-top-2 duration-300">
            <div className="bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-800 rounded-lg p-3 flex items-start gap-3 shadow-sm relative overflow-hidden">
                {/* AI Icon - Smaller */}
