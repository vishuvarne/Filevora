 ...
 */
export function convert_chunk(chunk) {
    const ptr0 = passArray8ToWasm0(chunk, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.convert_chunk(ptr0, len0);
    if (ret[1]) {
 ...
 */
export function init(job_type_id) {
    const ret = wasm.init(job_type_id);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
