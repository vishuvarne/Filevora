...
export function process_image(bytes: Uint8Array, operation: string, params: any): Uint8Array;
...
export function render_svg(svg_content: string, params: any): Uint8Array;
...
export function vectorize_image(bytes: Uint8Array, params: any): string;
...
export interface InitOutput {
    ...
    readonly process_image: (a: number, b: number, c: number, d: number, e: any) => [number, number, number, number];
    readonly render_svg: (a: number, b: number, c: any) => [number, number, number, number];
    readonly vectorize_image: (a: number, b: number, c: any) => [number, number, number, number];
