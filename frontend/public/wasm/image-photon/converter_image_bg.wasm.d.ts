...
export const process_image: (a: number, b: number, c: number, d: number, e: any) => [number, number, number, number];
export const render_svg: (a: number, b: number, c: any) => [number, number, number, number];
export const vectorize_image: (a: number, b: number, c: any) => [number, number, number, number];
